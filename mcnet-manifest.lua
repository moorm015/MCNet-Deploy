...
return {
    ...
    files = {
        ...
        {
            source = "services/trains/block_controller.lua",
            destination = "services/trains/block_controller.lua",
            packages = "TESTS"
        },
        {
        ...
        {
            source = "tests/trains/block_controller_test.lua",
            destination = "tests/trains/block_controller_test.lua",
            packages = "TESTS"
        },
        {
